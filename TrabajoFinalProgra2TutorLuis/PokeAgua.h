#pragma once
#include "Pokemon.h"
class CPokeAgua :	public CPokemon
{
...
public:
	CPokeAgua();
	CPokeAgua(char*nombre, int x, int y, int w, int h);
	~CPokeAgua();
...
CPokeAgua::CPokeAgua(){}
CPokeAgua::CPokeAgua(char*nombre,int x, int y, int w, int h) :CPokemon(nombre,x,y,w,h){
...
void CPokeAgua::TurnAttack(CPokemon*poke, ATTACK dmg){
