#pragma once
#include "Pokemon.h"
class CPokeFuego : public CPokemon
{
...
public:
	CPokeFuego();
	CPokeFuego(char*nombre, int x, int y, int w, int h);
	~CPokeFuego();
...
CPokeFuego::CPokeFuego(){}
CPokeFuego::CPokeFuego(char*nombre, int x, int y, int w, int h) :CPokemon(nombre, x, y, w, h){
...
void CPokeFuego::actualizar(){}

void CPokeFuego::TurnAttack(CPokemon*poke, ATTACK dmg){
